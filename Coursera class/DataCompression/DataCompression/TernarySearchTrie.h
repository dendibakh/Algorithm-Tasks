...
template <class T>
TernarySearchTrie<T>::Node::Node() : value(0), symbol(0), left(nullptr), equal(nullptr), right(nullptr)
{
}

template <class T>
TernarySearchTrie<T>::TernarySearchTrie() : root(nullptr)
{
}
...
class LZW_TST : public TernarySearchTrie<short>
{
	virtual bool checkExistNodeByValue(short value) const;
public:
	LZW_TST();
	virtual ~LZW_TST();
