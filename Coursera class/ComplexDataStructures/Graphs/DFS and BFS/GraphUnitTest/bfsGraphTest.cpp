...
namespace GraphUnitTest
{
	...
	public:
		...
		TEST_METHOD(CheckDistanceTo2)
		{
			...
			Assert::AreEqual(paths.distanceTo(9), 1);
			Assert::AreEqual(paths.distanceTo(10), 0);
			Assert::AreEqual(paths.distanceTo(11), 2);
			Assert::AreEqual(paths.distanceTo(12), 2);
		}
	};
}