...
namespace EWGraphUnitTest
{
	...
	public:
		...
		TEST_METHOD(ComputeMST)
		{
			...
			KruskalMST::MSTEdgesContainer container;
			container.push_back(Edge(0, 7, 0.16));
			container.push_back(Edge(2, 3, 0.17));
			container.push_back(Edge(1, 7, 0.19));
			container.push_back(Edge(0, 2, 0.26));
			container.push_back(Edge(5, 7, 0.28));
			container.push_back(Edge(4, 5, 0.35));
			container.push_back(Edge(2, 6, 0.40));
						
			KruskalMST mst(graph);
			KruskalMST::MSTEdgesContainer mstEdges = mst.edges();
